...
public class ImgDwnUIMultiPage {
    static File dir;
    ...
    public static void getMultiImages() throws InterruptedException, IOException {
    	for(int i = 145 ; i<= 148; i++) {
            ...
            navigateToPage("https://vipergirls.to/threads/1111573-Galitsin-Works-A-Z-(1999-2021)/page" + i);
            System.out.println("https://vipergirls.to/threads/1111573-Galitsin-Works-A-Z-(1999-2021)/page" + i);
    ...
    public static void createDirectory(String name) {
        ...
        dir = new File("D:\\temp\\GG\\GG9\\" + name);
        if (!dir.exists()) {
            dir.mkdirs();
        }
    }
